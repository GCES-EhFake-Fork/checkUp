...
class MaisGoias(BasePlay):
    name = "maisgoias"

    @classmethod
    def match(cls, url):
        return "maisgoias.com.br" in url
    ...
    def run(self) -> EntryItem:
        with sync_playwright() as p:
            ...
            # Extract description from entry-subtitle
            description = ""
            try:
                description = page.locator(".entry-subtitle").inner_text()
            except Exception:
            ...
            tags = []
            try:
                tag_elements = page.locator(".entry-tags a")
