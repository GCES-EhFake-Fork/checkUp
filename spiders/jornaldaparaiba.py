...
class JornalDaParaibaSpider(BaseSpider):
    name = "jornaldaparaiba"
    start_urls = ["https://jornaldaparaiba.com.br/"]
    allowed_domains = ["jornaldaparaiba.com.br"]
    ...
    def allow_url(self, url: str) -> bool:
        ...
        blacklist = {
            ...
            "/sobre", "/anuncie", "/assine", "/busca", "/expediente",
            "/jornal-da-paraiba-25-anos", "/colunistas", "/guia-qualaboa",
            "/vamos-trabalhar", "/educacao", "/espaco-opiniao"
        }

        if any(blacklisted in path for blacklisted in blacklist):
            return False
    ...
    def parse(self, response):
        ...
        """
        selectors = [
            "section.jpb-chamadaBoxHorizontal a[href]",
            "section.jpb-maisLidas a[href]",
            "section.jpb-chamadaBox a[href]",
            "section.jpb-ultimasNoticias a[href]",
        ]
